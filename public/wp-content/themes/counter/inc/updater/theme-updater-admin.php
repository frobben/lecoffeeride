 ...
 */
class Counter_Theme_Updater_Admin {
	...
	function __construct( $config = array(), $strings = array() ) {
		...
		add_action( 'tp_theme_info_screen_sidebar', array( $this, 'license_page' ), 100 );
	...
	function updater() {
		...
		if ( ! class_exists( 'Counter_Theme_Updater' ) ) {
			// Load our custom theme updater.
			include( dirname( __FILE__ ) . '/theme-updater-class.php' );
		}

		new Counter_Theme_Updater(
			array(
	...
	function license_page() {
		...
		if ( ! $license ) {
			...
			$message .= sprintf(
				...
				'https://docs.themepatio.com/find-license-key/',
		...
		require_once( get_template_directory() . '/inc/updater/theme-updater-widget-license.php' );
	}
