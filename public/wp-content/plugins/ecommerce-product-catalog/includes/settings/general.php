					...
					if ( !is_advanced_mode_forced() || ic_is_woo_template_available() || is_ic_shortcode_integration() ) {
						...
						<div class="ic-important-settings">
							...
							if ( is_ic_shortcode_integration() ) {
								...
								<table>
									<?php
									$descriptions[ 'simple' ]	 = '<strong>' . __( 'Simple Mode', 'ecommerce-product-catalog' ) . '</strong>' . ' - ' . __( 'will use your theme page template but category pages are disabled.', 'ecommerce-product-catalog' );
									...
									implecode_settings_radio( __( 'Layout mode', 'ecommerce-product-catalog' ), 'archive_multiple_settings[integration_type][' . $theme . ']', $archive_multiple_settings[ 'integration_type' ][ $theme ], array( 'advanced' => $descriptions[ 'advanced' ], 'theme' => $descriptions[ 'theme' ], 'simple' => $descriptions[ 'simple' ] ), 1, sprintf( __( 'Choose Advanced Mode if you want to display catalog categories and search with %s layout.', 'ecommerce-product-catalog' ), IC_CATALOG_PLUGIN_NAME ), '<br>', "integration-mode-selection" );
									?></table>
								...
								<div class="advanced_mode_settings">
									...
									?>
									<table class="advanced_mode_settings_hidden"><?php
